    ...
    <form action={createProperty} className="space-y-6">
      <Section title="Información básica">
        <div>
          ...
          <input name="title" required placeholder="Casa en Lomas de Turi" className={field} />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className={label}>Tipo *</label>
            <select name="type" required defaultValue="apartment" className={field}>
          ...
          <div>
            ...
            <select name="operation" required defaultValue="sale" className={field}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select name="line" defaultValue="segunda" className={field}>
      ...
      <Section title="Precio y características">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input name="price" type="number" min="0" step="0.01" required placeholder="150000" className={field} />
          </div>
          <div>
            <label className={label}>Área (m²)</label>
            <input name="area_m2" type="number" min="0" step="0.1" placeholder="120" className={field} />
          </div>
        </div>
        <div className="grid grid-cols-3 gap-4">
          <div>
            <label className={label}>Habitaciones</label>
            <input name="bedrooms" type="number" min="0" placeholder="3" className={field} />
          </div>
          <div>
            <label className={label}>Baños</label>
            <input name="bathrooms" type="number" min="0" step="0.5" placeholder="2" className={field} />
          </div>
          <div>
            <label className={label}>Parqueos</label>
            <input name="parking" type="number" min="0" placeholder="1" className={field} />
          </div>
        </div>
      </Section>
      ...
      <Section title="Ubicación">
        <div>
          ...
          <input name="address" placeholder="Av. de las Américas y Pumapungo" className={field} />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className={label}>Sector / Barrio</label>
            <input name="neighborhood" placeholder="El Batán" className={field} />
          </div>
          <div>
            <label className={label}>Ciudad</label>
            <input name="city" defaultValue="Cuenca" placeholder="Cuenca" className={field} />
          </div>
        </div>
      </Section>
      ...
      <Section title="Descripción y extras">
        <div>
          ...
          <textarea name="description" rows={3} placeholder="Descripción de la propiedad..." className={`${field} resize-none`} />
        </div>
        <div>
          <label className={label}>URL álbum de fotos</label>
          <input name="photos_album_url" type="url" placeholder="https://photos.google.com/..." className={field} />
        </div>
        <div>
          <label className={label}>Código externo</label>
          <input name="external_code" placeholder="CH-001" className={field} />
        </div>
        <div>
          <label className={label}>Notas internas</label>
          <textarea name="notes" rows={2} placeholder="Notas para el equipo..." className={`${field} resize-none`} />
        </div>
      </Section>
